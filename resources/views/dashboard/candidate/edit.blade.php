        ...
        <div class="flex flex-wrap -mx-3">
            <div class="w-full max-w-full px-3 m-auto flex-0 lg:w-8/12">
                <div
                    ...
                    <div class="flex-auto">
                        <p class="p-6 text-sm leading-normal uppercase dark:text-white dark:opacity-60">Edit Candidate</p>
                        <form action="{{ route('candidate.update', $candidate->id) }}" class="p-4 md:p-5"
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="name" required
                                            ...
                                            placeholder="eg. Ali Murofid" value="{{ old('name', $candidate->name) }}">
                                        @error('name')
                                            <div class="mt-2 text-sm text-red-500">
                                                {{ $message }}
                                            </div>
