        ...
        <div class="flex flex-wrap items-center -mx-3 lg:justify-between">
            <div class="w-full max-w-full px-3 mt-0 mb-6 shrink-0 lg:mb-0 lg:w-1/2 lg:flex-none">
                <div class="text-sm leading-normal text-center text-slate-500 lg:text-left">
                    ...
                    for a better web. <i class="fa-solid fa-code"></i> by <a
                        class="font-semibold text-blue-600 dark:text-white"
                        href="https://github.com/alimurrofid/formadiksivote" target="_blank">Formadiksi Mroyek<svg
                            xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor"
                            class="inline bi bi-rocket-takeoff ms-1" viewBox="0 0 16 16">
                            <path
