                        ...
                        <div class="flex flex-row ">
                            ...
                            <div class="px-3 text-right">
                                <div
                                    ...
                                    <i class="relative text-3xl text-white fa-solid fa-user-check top-3.5"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex flex-row ">
                            ...
                            <div class="px-3 text-right">
                                <div
                                    ...
                                    <i class="relative text-3xl text-white fa-solid fa-user-xmark top-3.5"></i>
                                </div>
                            </div>
                        </div>
                    </div>
...
@push('customJS')
    <script>
        var labels = {{ Js::from($name) }};
        var users = {{ Js::from($vote_count) }};
        ...
        const QuickVote = new Chart(
            document.getElementById('QuickVote'),
            config
        );
    </script>
@endpush
