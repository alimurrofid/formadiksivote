...
<div class="flex flex-wrap justify-between pt-10 my-10 lg:mx-20 mx-7 lg:my-20">
    ...
    <div class="relative mx-auto md:mt-10 lg:mt-0 mt-14 lg:mx-0">
        ...
        <iframe class="rounded-lg lg:w-[400px] w-[300px] lg:h-[265px] h-[165px]" src="https://www.youtube.com/embed/gKRjPljAB08?si=1L_vTwXsYPBADEzn" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    </div>
</div>
